            ...
            <form @submit="formSubmit" @reset="formReset">
                ...
                <view class="sss">
                    ...
                    <radio-group name="radio">
						...
						<label>
						    <radio value="radio3" /><text>选项二</text>
						</label>
                    </radio-group>
                </view>
                <view class="uni-form-item uni-column">
                    ...
                    <checkbox-group name="checkbox">
						...
						<label>
						    <checkbox value="checkbox4" /><text>选项4</text>
						</label>
                    </checkbox-group>
                </view>
				<view class="uni-form-item uni-column">
                ...
                <view class="uni-btn">
                    <button plain="false" loading="3" type="warn" size="default"  form-type="submit">Submit</button>
